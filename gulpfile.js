...
gulp.task('concatjs', function(){
    return gulp
        .src([config.bowerDir + '/bootstrap-sass/assets/javascripts/bootstrap.js', config.cssPath + '/lib/owl.carousel.js', config.cssPath + '/lib/jquery-scrolltofixed.js', config.cssPath + '/lib/main.js'])
        .pipe(concat('main.js'))
