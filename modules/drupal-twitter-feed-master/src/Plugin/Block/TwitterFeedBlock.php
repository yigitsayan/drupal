...
class TwitterFeedBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    foreach($tweets as $key => $tweet) {
      ...
      $tweets_text[$key]['screenName'] = $tweet['user']['name'];
      $tweets_text[$key]['username']   = $tweet['user']['screen_name'];
      $tweets_text[$key]['userImage']  = str_replace('normal', '400x400', $tweet['user']['profile_image_url']);
    }
